        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        //ConnectionString = 
                        //    "Endpoint=sb://mechub.servicebus.usgovcloudapi.net/;" +
                        //    "SharedAccessKeyName=HubApplicationAccessKey;" + 
                        //    "SharedAccessKey=act+lY5YtDqrQQJvP+NCFyEZiqP1eEuq4KuLZSn4+ac=";
                        //ConnectionString =
                        //   "Endpoint=sb://mechub.servicebus.usgovcloudapi.net/;" +
                        //   "SharedAccessKeyName=RootManageSharedAccessKey;" +
                        //   "SharedAccessKey=4a+OEkiuNkUcDH/jSeKorEKXm71JoSRSWVxUwLV8XPo=";
